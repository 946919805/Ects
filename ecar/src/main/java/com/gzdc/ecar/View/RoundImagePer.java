 ...
 */
public class RoundImagePer extends ImageView {
    ...
    public RoundImagePer(Context context) {
        super(context);
        mContext = context;
    }

    public RoundImagePer(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public RoundImagePer(Context context, AttributeSet attrs, int defStyle) {
